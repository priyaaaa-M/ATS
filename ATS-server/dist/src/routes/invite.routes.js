...
router.post('/generate', (0, role_middleware_1.requireRole)('hr'), invite_controller_1.inviteController.generate);
router.get('/', (0, role_middleware_1.requireRole)('hr'), invite_controller_1.inviteController.list);
