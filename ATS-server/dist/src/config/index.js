...
exports.config = {
    ...
    scheduling: {
        ...
        defaultInterviewDurationMinutes: optionalNumber('DEFAULT_INTERVIEW_DURATION_MINUTES', 45),
    },
    jobs: {
        transcriptCron: optional('TRANSCRIPT_JOB_CRON', '*/15 * * * *'),
        transcriptFetchLookbackHours: optionalNumber('TRANSCRIPT_FETCH_LOOKBACK_HOURS', 24),
        transcriptFetchDelayMinutes: optionalNumber('TRANSCRIPT_FETCH_DELAY_MINUTES', 30),
    },
    sync: {
