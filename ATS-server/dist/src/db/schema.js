...
exports.notifications = exports.interviewTranscripts = exports.interviewFeedback = exports.scheduledInterviews = exports.invites = exports.candidates = exports.interviewRounds = exports.roleDetails = exports.roles = exports.syncStates = exports.driveConfigs = exports.users = exports.companies = void 0;
const pg_core_1 = require("drizzle-orm/pg-core");
exports.companies = (0, pg_core_1.pgTable)('companies', {
    id: (0, pg_core_1.uuid)('id').primaryKey().defaultRandom(),
    name: (0, pg_core_1.text)('name').notNull(),
    logoUrl: (0, pg_core_1.text)('logo_url'),
    brandColor: (0, pg_core_1.text)('brand_color').default('#0D7377'),
    slackWebhookUrl: (0, pg_core_1.text)('slack_webhook_url'),
    slackChannelName: (0, pg_core_1.text)('slack_channel_name'),
    slackEvents: (0, pg_core_1.jsonb)('slack_events').$type(),
...
exports.roleDetails = (0, pg_core_1.pgTable)('role_details', {
    id: (0, pg_core_1.uuid)('id').primaryKey().defaultRandom(),
    companyId: (0, pg_core_1.uuid)('company_id').references(() => exports.companies.id),
    userId: (0, pg_core_1.uuid)('user_id').references(() => exports.users.id),
    name: (0, pg_core_1.text)('name').notNull(),
    ...
    description: (0, pg_core_1.text)('description'),
    hiringGoals: (0, pg_core_1.text)('hiring_goals'),
    salaryMin: (0, pg_core_1.integer)('salary_min'),
    salaryMax: (0, pg_core_1.integer)('salary_max'),
    salaryCurrency: (0, pg_core_1.text)('salary_currency').default('INR'),
    expectations: (0, pg_core_1.text)('expectations'),
    activities: (0, pg_core_1.text)('activities'),
    workTags: (0, pg_core_1.jsonb)('work_tags').$type(),
    sellingPoints: (0, pg_core_1.text)('selling_points'),
    screeningGuide: (0, pg_core_1.text)('screening_guide'),
    outreachTemplate: (0, pg_core_1.text)('outreach_template'),
    screeningQuestions: (0, pg_core_1.jsonb)('screening_questions'),
    interviewStages: (0, pg_core_1.jsonb)('interview_stages'),
    status: (0, pg_core_1.text)('status').default('open'),
    hiringManagerId: (0, pg_core_1.uuid)('hiring_manager_id').references(() => exports.users.id),
    assignedRecruiterIds: (0, pg_core_1.jsonb)('assigned_recruiter_ids').$type(),
...
exports.candidates = (0, pg_core_1.pgTable)('candidates', {
    ...
    inboxStatus: (0, pg_core_1.text)('inbox_status').default('inbox'),
    currentStage: (0, pg_core_1.text)('current_stage'),
    stageHistory: (0, pg_core_1.jsonb)('stage_history'),
    notes: (0, pg_core_1.jsonb)('notes'),
    screeningAnswers: (0, pg_core_1.jsonb)('screening_answers'),
    matchScore: (0, pg_core_1.integer)('match_score').default(0),
    matchBreakdown: (0, pg_core_1.jsonb)('match_breakdown'),
